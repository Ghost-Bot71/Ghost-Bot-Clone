...
module.exports = async (api) => {
	...
	// Ghost Bot: Gmail is optional — skip if credentials not provided
	...
	if (clientId && clientSecret && refreshToken && email) {
		...
		try {
			...
			console.warn("Ghost Bot: Gmail OAuth error:", err.message);
		}
		if (accessToken) {
		...
		console.warn("\u{1F47B} Ghost Bot: Dashboard Gmail disabled");
	}
